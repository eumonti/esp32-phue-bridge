...
void setup() {
  ...
  bleInterface.setPowerStateCallback(std::bind(&SPInterface::updatePowerState, &sinricProInterface, _1));
  bleInterface.setBrightnessCallback(std::bind(&SPInterface::updateBrightness, &sinricProInterface, _1));
